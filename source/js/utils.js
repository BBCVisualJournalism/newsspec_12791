define(['lib/news_special/bootstrap'], function (news) {
    var removeSpecialCharsLookup = { '\\$': 's', '\\.': '', '’': '', '/': '', ', ': '-', '\\(': '', '\\)': '', '\'': '', ' ': '' };

    var removeSpecialChars = function (string) {
        for (var key in removeSpecialCharsLookup) {
            string = string.replace(new RegExp(key, 'g'), removeSpecialCharsLookup[key]);
        }
        return string;
    };

    // removeDiacritics source: http://stackoverflow.com/a/18391901
    ...
    var normaliseFilename = function (string) {
        return removeSpecialChars(removeDiacritics(string.toLowerCase()));
    };
    ...
    var publicApi = {
        ...
        defaultDiacriticsRemovalMap: defaultDiacriticsRemovalMap,
        removeDiacritics: removeDiacritics,
        normaliseFilename: normaliseFilename,
